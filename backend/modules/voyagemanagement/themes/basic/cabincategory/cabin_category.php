							...
							<table>
								...
								<?php foreach ($pagedata as $k=>$v):?>
									<tr>
										...
										<td>
											<a href="<?php echo Url::toRoute(['cabincategoryoption','class_id'=>$v['class_id']]);?>"><img src="<?=$baseUrl ?>images/write.png"></a>
...
$("#bigclass").click(function(){
	...
	$("input#cabininsert").click(function(){
		 location.href="<?php echo Url::toRoute(['cabincategoryoption']);?>";
...
window.onload = function(){ 
	...
	?>
		$('#type_config_page_div').jqPaginator({
		    ...
		    onPageChange: function (num, type) {
		    	...
		    	$.ajax({
	                url:"<?php echo Url::toRoute(['getcabinclasspage']);?>",
	                type:'POST',
   ...
   $(document).on('click',"#promptBox > .btn .confirm_but",function(){
	   ...
	   location.href="<?php echo Url::toRoute(['cabincategory']);?>"+"&code="+val;
   });

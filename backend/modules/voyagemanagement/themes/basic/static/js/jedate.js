...
(function(window) {
	...
	*/
	...
	jeDt.weeks = [ "Sun", "Mon", "Tue", "Wed", "Thu", "May", "Sat" ];
    //判断元素类型
	...
	jeDt.setHtml = function(opts, self, lyerCell) {
		...
		var bothmsStr = !isYYMM ? '<div class="botflex jedatehmsshde"><ul class="jedatehms"><li><em></em><i>:</i></li><li><em></em><i>:</i></li><li><em></em></li></ul></div>' + '<div class="botflex jedatebtn"><span class="jedateok">Confirm</span><span class="jedatetodaymonth">Today</span><span class="jedateclear">Clean</span></div>' :'<div class="botflex jedatebtn"><span class="jedateok">Confirm</span><span class="jedatetodaymonth"></span><span class="jedateclear">Clean</span></div>';
		var datebotStr = '<div class="jedatebot">' + bothmsStr + "</div>";
		var datehmschoose = '<div class="jedateprophms '+(ishhmmss ? "jedatepropfix" : "jedateproppos")+'" prop="true"><div class="jedatepropcon"><div class="jedatehmstitle">Pick Up<div class="jedatehmsclose">&times;</div></div><div class="jedateproptext">Hour</div><div class="jedateproptext">Minute</div><div class="jedateproptext">Second</div><div class="jedatehmscon jedateprophours"></div><div class="jedatehmscon jedatepropminutes"></div><div class="jedatehmscon jedatepropseconds"></div></div></div>';
		...
		if (!isYYMM) {
			...
			jeDt.text(QD(lyerCell + " .jedateym .jedateyearmonth")[0], tms[0] + jeDt.digit(tms[1]));
	...
	jeDt.getDateStr = function(opts, lyerCell, y, m, d) {
		...
		jeDt.each(QD(lyerCell + " .jedateyear"),function(i,elem){
			jeDt.text(elem, y ).attr(elem, "data-year", y);
		})
		jeDt.each(QD(lyerCell + " .jedatemonth"),function(i,elem){
			jeDt.text(elem, m ).attr(elem, "data-month", m);
		})

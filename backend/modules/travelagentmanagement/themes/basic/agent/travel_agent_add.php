				...
				<div>
					<p>
						<label>
							...
							<input type="text" name="travel_agent_code" readonly="true" style="background-color:#E5E5E5;border:#B9B9B9 1px solid"></input>
						...
						<label>
							...
							<?php foreach ($gradeinfo as $k=>$v):?>
								<option value="<?php echo  $v['id']?>"><?php echo  $v['travel_agent_level']?></option>
								<?php endforeach;?>
							</select>
						</label>
					</p>
					<p>
						...
						<label>
							...
							<input  type="text" name="contract_start_time"  onfocus="WdatePicker({dateFmt:'dd-MM-yyyy HH:mm:ss'})" class="Wdate" /> 
							<span class="point"  style="display:none" ><?php echo yii::t('app','Required fields can not be empty ')?></span>
						</label>
					</p>
					<p>
						<label>
							...
							<select  name="travel_agent_status" class="selectWidth statuscheck">
								...
								<option value="0" selected="selected"><?php echo yii::t('app', 'Unavaliable')?></option>
							</select>
						...
						<label>
							...
							<input type="text" name="contract_end_time"  onfocus="WdatePicker({dateFmt:'dd-MM-yyyy HH:mm:ss'})" class="Wdate"></input>
						<span class="point"  style="display:none"><?php echo yii::t('app','Required fields can not be empty ')?></span>
						</label>
					...
					<p>
						<label>
							...
							<select name="is_online_booking" class="selectWidth">
								<option value="0"><?php echo yii::t('app', 'Normal Agents')?></option>
									<option value="1"><?php echo yii::t('app', 'Inside Agents')?></option>
							</select>
						</label>
						<label>
					...
					<p>
						...
						<label>
							...
							<input type="text" name="travel_agent_admin"  ></input>
							<span class="point"  style="display:none"><?php echo yii::t('app','Required fields can not be empty ')?></span>
					...
					<p>
						<label>
							...
							<input type="text"  name="travel_agent_contact_phone" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" ></input>
								<span id="contactvalidate" class="point"  style="display:none"><?php echo yii::t('app', 'Contact Number is error')?></span>
					...
					<p>
						<label>
							...
							<?php foreach ($cityinfo as $k=>$v):?>
								<option value="<?php echo $v['city_code']?>"><?php echo $v['city_name']?></option>
								<?php endforeach;}?>
							</select>
						</label>
							<label>

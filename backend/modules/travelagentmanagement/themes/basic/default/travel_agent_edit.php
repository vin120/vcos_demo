	...
	<style type="text/css">
				...
				<div>
					<p>
						<label>
							...
							<input type="text" name="travel_agent_code" style="background-color:#F6F6F6" readonly="true" value="<?php echo yii::t('vcos', $ageninfo[0]['travel_agent_code'])?>"></input>
						<span class="point"  style="display:none"><?php echo yii::t('vcos','Required fields cannot be empty ')?></span>
						</label>
						<label>
							...
							<?php foreach ($gradeinfo as $k=>$v):?>
								<option value="<?php echo  $v['travel_agent_higher_level_id']?>" <?php echo $v['travel_agent_higher_level_id']==$ageninfo[0]['travel_agent_level']?"selected='selected'":''?>><?php echo yii::t('vcos', $v['travel_agent_level'])?></option>
								<?php endforeach;?>
							</select>
					...
					<p>
						<label>
							...
							<input type="text" name="sort_order" value="<?php echo yii::t('vcos', $ageninfo[0]['sort_order'])?>" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"></input>
						...
						<label>
							...
							<input type="text" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"  class="Wdate" name="contract_start_time"   value="<?php echo $ageninfo[0]['contract_start_time']?>"></input>
						<span class="point"  style="display:none"><?php echo yii::t('vcos','Required fields can not be empty ')?></span>
						</label>
					</p>
					<p>
						<label class="shortLabel">
							...
							<select name="travel_agent_status">
								<option value="1" <?php echo $ageninfo[0]['travel_agent_status']==1?"selected='selected'":''?>><?php echo yii::t('vcos', 'Usable')?></option>
								<option value="0" <?php echo $ageninfo[0]['travel_agent_status']==0?"selected='selected'":''?>><?php echo yii::t('vcos', 'Disable')?></option>
							</select>
						</label>
						<label>
							<span><?php echo yii::t('vcos', 'Contract End Time:')?></span>
							<input type="text" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" class="Wdate" name="contract_end_time" value="<?php echo $ageninfo[0]['contract_end_time']?>"></input>
						<span class="point"  style="display:none"  style="display:none"><?php echo yii::t('vcos','Required fields can not be empty ')?></span>
						<span id="contract_end_time1"  style="display:none" class="point"><?php echo yii::t('vcos', 'Start is not greater than End')?></span>
						</label>
					</p>
					<p>
						<label>
							<span><?php echo yii::t('vcos','Agent Name:')?></span>
							<input type="text" name="travel_agent_name" value="<?php echo yii::t('vcos',$ageninfo[0]['travel_agent_name'])?>"></input>
						<span class="point"  style="display:none"><?php echo yii::t('vcos','Required fields can not be empty ')?></span>
						</label>
						<label>
							<span><?php echo yii::t('vcos', 'Account Holder:')?></span>
							<input type="text" name="travel_agent_bank_holder" value="<?php echo yii::t('vcos',$ageninfo[0]['travel_agent_bank_holder'])?>"></input>
						<span class="point"  style="display:none"><?php echo yii::t('vcos','Required fields can not be empty ')?></span>
						</label>
					</p>
					<p>
						<label class="shortLabel">
							...
							<select name="is_online_booking">
								<option value="0" <?php echo $ageninfo[0]['is_online_booking']==0?"selected='selected'":''?>><?php echo yii::t('vcos', 'Normal Agents')?></option>
									<option value="1"  <?php echo $ageninfo[0]['is_online_booking']==1?"selected='selected'":''?>><?php echo yii::t('vcos', 'Inside Agents')?></option>
							</select>
						</label>
						<label>
							<span><?php echo yii::t('vcos', 'Bank:')?></span>
							<input type="text" name="travel_agent_account_bank" value="<?php echo yii::t('vcos', $ageninfo[0]['travel_agent_account_bank'])?>"></input>
						<span class="point"  style="display:none"><?php echo yii::t('vcos','Required fields can not be empty ')?></span>
						</label>
					</p>
					<p>
						<label>
							...
							<input type="text" name="travel_agent_phone" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" value="<?php echo yii::t('vcos', $ageninfo[0]['travel_agent_phone'])?>"></input>
						<span class="point"  style="display:none"><?php echo yii::t('vcos','Required fields can not be empty ')?></span>
						</label>
						<label>
							<span><?php echo yii::t('vcos', 'Bank Account:')?></span>
							<input type="text" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" name="travel_agent_account" value="<?php echo yii::t('vcos', $ageninfo[0]['travel_agent_account'])?>"></input>
						<span class="point"  style="display:none"><?php echo yii::t('vcos','Required fields can not be empty ')?></span>
						</label>
					</p>
					<p>
						<label>
							...
							<input type="text" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" id="travel_agent_fax" name="travel_agent_fax" value="<?php echo yii::t('vcos', $ageninfo[0]['travel_agent_fax'])?>"></input>
						<span class="point"  style="display:none" ><?php echo yii::t('vcos','Required fields can not be empty ')?></span>
						</label>
						<label>
							<span><?php echo yii::t('vcos', 'System Account:')?></span>
							<input type="text" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"  name="travel_agent_admin" value="<?php echo yii::t('vcos', $ageninfo[0]['travel_agent_admin'])?>"></input>
						<span class="point"  style="display:none"><?php echo yii::t('vcos','Required fields can not be empty ')?></span>
						</label>
					</p>
					<p>
						<label>
							...
							<input type="text" name="travel_agent_contact_name"  value="<?php echo yii::t('vcos', $ageninfo[0]['travel_agent_contact_name'])?>"></input>
						<span class="point"  style="display:none"><?php echo yii::t('vcos','Required fields can not be empty ')?></span>
						</label>
						<label>
							<span><?php echo yii::t('vcos', 'Account Password:')?></span>
							<input type="password" name="travel_agent_password" value="<?php echo yii::t('vcos', $ageninfo[0]['travel_agent_password'])?>"></input>
						<span class="point"  style="display:none"><?php echo yii::t('vcos','Required fields can not be empty ')?></span>
						</label>
					</p>
					<p>
						<label>
							...
							<input type="text" name="travel_agent_contact_phone" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"  value="<?php echo yii::t('vcos', $ageninfo[0]['travel_agent_contact_phone'])?>"></input>
						<span id="contactvalidate"  style="display:none" class="point"><?php echo yii::t('vcos', 'Contact Number is error')?></span>
						...
						<label>
							...
							<input type="password" name="pay_password" value="<?php echo yii::t('vcos', $ageninfo[0]['pay_password'])?>"></input>
						<span class="point"  style="display:none"><?php echo yii::t('vcos','Required fields can not be empty ')?></span>
						</label>
					</p>
					<p>
						<label>
							...
							<input type="text" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" name="travel_agent_post_code" value="<?php echo yii::t('vcos', $ageninfo[0]['travel_agent_post_code'])?>"></input>
						<span class="point"  style="display:none"><?php echo yii::t('vcos','Required fields can not be empty ')?></span>
						</label>
						<label>
							<span><?php echo yii::t('vcos', 'Commission:')?></span>
							<input type="text" name="commission_percent" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" value="<?php echo yii::t('vcos', $ageninfo[0]['commission_percent'])?>"></input>%
					...
					<p>
						<label>
							...
							<?php foreach ($contryinfo as $k=>$v):?>
								<option value="<?php echo $v['country_code']?>" <?php echo $v['country_code']==$ageninfo[0]['country_code']?"selected='selected'":''?>><?php echo yii::t('vcos', $v['country_name'])?></option>
								<?php endforeach;?>
							</select>
							<select name="city_code" id="city_code">
							
							<?php foreach ($cityinfo as $k=>$v):?>
								<option value="<?php echo $v['city_code']?>" <?php echo $v['city_code']==$ageninfo[0]['city_code']?"selected='selected'":''?>><?php echo yii::t('vcos', $v['city_name'])?></option>
							<?php endforeach;?>
							</select>
						</label>
						<label>
						...
						<?php foreach ($superinfo as $k=>$v):?>
							<option value="<?php echo $v['travel_agent_level']?>"><?php echo $v['travel_agent_name']?></option>
							<?php endforeach;?>
							<?php }else{?>
							<option value=""><?php echo yii::t('vcos', 'no')?></option>
							<?php }?>
							</select>
						</label>
					</p>
					<p>
						<label>
							...
							<input type="text" name="travel_agent_address" value="<?php echo yii::t('vcos', $ageninfo[0]['travel_agent_address'])?>"></input>
						<span class="point"  style="display:none"><?php echo yii::t('vcos','Required fields can not be empty ')?></span>
						</label>
						<label>
							<span><?php echo yii::t('vcos', 'Email:')?></span>
							<input type="text" name="travel_agent_email" value="<?php echo yii::t('vcos',$ageninfo[0]['travel_agent_email'])?>"></input>
		...
		<script type="text/javascript">
		 ...
		 window.location = "<?php echo Url::toRoute(['travel_agent']);?>";
		 	...
		 	/* 		 if($("input[name=travel_agent_contact_phone]").prop("class")=="point"){
					return
			 			} 
	 			 else if($("input[name=travel_agent_email]").prop("class")=="point"){
						return false;
		 				}  */
		 			 /* 	var returnsubmit=1;
